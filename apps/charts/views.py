...
class progress(APIView):
	...
	def get(self, request, *args, **kwargs):
		...
		reproduction_list = {"繁殖云测试计划": ["猪只档案", "引种管理", "新开场管理", "公猪管理", "后备管理", "经产管理", "育种管理", "死淘管理", "猪场关账"]}
		fattenone_list = {"育肥云测试计划": ["基础资料", "养户管理", "投苗管理", "饲养管理", "上市管理", "结算管理", "成本管理", "免疫保健", "邦养宝-公共组件"]}
		...
		fattentwo_list = {"自养育肥云": ["基础档案", "投苗管理业务流程", "饲养管理业务流程", "猪只变动业务流程", "物资领用"]}
		fattentwoapp_list = {
